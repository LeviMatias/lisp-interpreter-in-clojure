...
(defn evaluar-secuencia-en-cond [lis amb-global amb-local](
   cond (<= 1 (count lis)) (evaluar (first lis) amb-global amb-local)
...
(defn evaluar-cond [lis amb-global amb-local](
    ...
    (evaluar (ffirst lis) amb-global amb-local) (evaluar-secuencia-en-cond (nfirst lis) amb-global amb-local)
